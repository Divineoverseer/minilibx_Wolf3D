...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/11/02 15:53:16 by dmaltsev          #+#    #+#              #
#    Updated: 2018/05/07 17:08:55 by dmaltsev         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME	:= libft.a

SRCS	:= ft_atoi.c ft_bzero.c ft_cnum.c ft_countd.c ft_freelst.c ft_freestrarr.c \
	...
	ft_putendl_fd.c ft_putnbr.c ft_putnbr_fd.c ft_putstr.c ft_putstr_fd.c ft_revers.c \
	ft_rnum.c ft_strcat.c ft_strchr.c ft_strclr.c ft_strcmp.c ft_strcpy.c ft_strdel.c \
